# DaemonSet Mandatory Tags/Labels Enforcement Policy

## 📋 Summary

**Policy Name**: DaemonSet Mandatory Tags/Labels Enforcement  
...
Enforce that all Kubernetes DaemonSet containers have mandatory tags/labels configured to prevent resource contention and unpredictable performance.

## 📝 Description

This policy validates that all containers in Kubernetes DaemonSets have mandatory tags/labels specified in their resource requirements. This ensures proper resource management and prevents resource contention.

## ✅ Policy Rules

- **Valid**: DaemonSets where all containers have mandatory tags/labels configured
- **Invalid**: DaemonSets where any container is missing mandatory tags/labels
- **Skip**: Non-DaemonSet resources (Pods, Services, other workload types, etc.)

## 📁 Project Structure

```
daemonset_mandatory_tags/
├── README.md                              # This file
...
# Navigate to daemonset_mandatory_tags
cd daemonset_mandatory_tags
