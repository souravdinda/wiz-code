...
# Test script for DaemonSet Mandatory Tags Enforcement Policy
...
echo "Testing DaemonSet Mandatory Tags Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-daemonset-with-tags.json" "ALLOWED" "Daemonset with all mandatory tags"

# Invalid cases (should be DENIED/fail)
test_case "invalid-daemonset-missing-tags.json" "DENIED" "Daemonset missing mandatory tags"
