# Deployment Memory Limits Enforcement Policy

## 📋 Summary

**Policy Name**: Deployment Memory Limits Enforcement  
...
Enforce that all Kubernetes Deployment containers have memory limits configured to prevent resource contention and unpredictable performance.

## 📝 Description

This policy validates that all containers in Kubernetes Deployments have memory limits specified in their resource requirements. This ensures proper resource management and prevents resource contention.

## ✅ Policy Rules

- **Valid**: Deployments where all containers have memory limits configured
- **Invalid**: Deployments where any container is missing memory limits
- **Skip**: Non-Deployment resources (Pods, Services, other workload types, etc.)

## 📁 Project Structure

```
deployment_memory_limits/
├── README.md                              # This file
...
# Navigate to deployment_memory_limits
cd deployment_memory_limits
