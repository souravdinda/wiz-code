...
# Test script for Deployment Memory Limits Enforcement Policy
...
echo "Testing Deployment Memory Limits Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-deployment.json" "ALLOWED" "Deployment with memory limit"

# Invalid cases (should be DENIED/fail)
test_case "invalid-deployment-missing-memory-limit.json" "DENIED" "Deployment missing memory limit"
