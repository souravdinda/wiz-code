# Deployment Mandatory Tags/Labels Enforcement Policy

## 📋 Summary

**Policy Name**: Deployment Mandatory Tags/Labels Enforcement  
...
Enforce that all Kubernetes Deployment containers have mandatory tags/labels configured to prevent resource contention and unpredictable performance.

## 📝 Description

This policy validates that all containers in Kubernetes Deployments have mandatory tags/labels specified in their resource requirements. This ensures proper resource management and prevents resource contention.

## ✅ Policy Rules

- **Valid**: Deployments where all containers have mandatory tags/labels configured
- **Invalid**: Deployments where any container is missing mandatory tags/labels
- **Skip**: Non-Deployment resources (Pods, Services, other workload types, etc.)

## 📁 Project Structure

```
deployment_mandatory_tags/
├── README.md                              # This file
...
# Navigate to deployment_mandatory_tags
cd deployment_mandatory_tags
