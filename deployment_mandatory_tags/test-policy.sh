...
# Test script for Deployment Mandatory Tags Enforcement Policy
...
echo "Testing Deployment Mandatory Tags Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-deployment-with-tags.json" "ALLOWED" "Deployment with all mandatory tags"

# Invalid cases (should be DENIED/fail)
test_case "invalid-deployment-missing-tags.json" "DENIED" "Deployment missing mandatory tags"
