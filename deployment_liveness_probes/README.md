# Deployment Liveness And Readiness Probes Enforcement Policy

## 📋 Summary

**Policy Name**: Deployment Liveness And Readiness Probes Enforcement  
...
Enforce that all Kubernetes Deployment containers have liveness and readiness probes configured to prevent resource contention and unpredictable performance.

## 📝 Description

This policy validates that all containers in Kubernetes Deployments have liveness and readiness probes specified in their resource requirements. This ensures proper resource management and prevents resource contention.

## ✅ Policy Rules

- **Valid**: Deployments where all containers have liveness and readiness probes configured
- **Invalid**: Deployments where any container is missing liveness and readiness probes
...
# Navigate to deployment_probes
cd deployment_probes
