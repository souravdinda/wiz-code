...
# Test script for Deployment Probes Enforcement Policy
...
echo "Testing Deployment Probes Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-deployment-with-probes.json" "ALLOWED" "Deployment with both liveness and readiness probes"

# Invalid cases (should be DENIED/fail)
test_case "invalid-deployment-missing-liveness.json" "DENIED" "Deployment missing liveness probe"
test_case "invalid-deployment-missing-readiness.json" "DENIED" "Deployment missing readiness probe"

# Non-Deployment resources (should be SKIPPED)
test_case "not-deployment-pod.json" "SKIPPED" "Pod (not a Deployment, policy doesn't apply)"
