...
# Test script for Deployment Memory Requests Enforcement Policy
...
echo "Testing Deployment Memory Requests Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-deployment.json" "ALLOWED" "Deployment with memory request"

# Invalid cases (should be DENIED/fail)
test_case "invalid-deployment-missing-memory-request.json" "DENIED" "Deployment missing memory request"
test_case "invalid-deployment-no-resources.json" "DENIED" "Deployment with no resources section"
