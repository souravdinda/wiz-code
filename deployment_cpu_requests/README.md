# Deployment Cpu Requests Enforcement Policy

## 📋 Summary

**Policy Name**: Deployment Cpu Requests Enforcement  
...
Enforce that all Kubernetes Deployment containers have CPU requests configured to prevent resource contention and unpredictable performance.

## 📝 Description

This policy validates that all containers in Kubernetes Deployments have CPU requests specified in their resource requirements. This ensures proper resource management and prevents resource contention.

## ✅ Policy Rules

- **Valid**: Deployments where all containers have CPU requests configured
- **Invalid**: Deployments where any container is missing CPU requests
- **Skip**: Non-Deployment resources (Pods, Services, other workload types, etc.)

## 📁 Project Structure

```
deployment_cpu_requests/
├── README.md                              # This file
...
# Navigate to deployment_cpu_requests
cd deployment_cpu_requests
