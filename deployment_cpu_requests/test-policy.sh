...
# Test script for Deployment CPU Requests Enforcement Policy
...
echo "Testing Deployment CPU Requests Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-deployment.json" "ALLOWED" "Deployment with cpu request"

# Invalid cases (should be DENIED/fail)
test_case "invalid-deployment-missing-cpu-request.json" "DENIED" "Deployment missing cpu request"
