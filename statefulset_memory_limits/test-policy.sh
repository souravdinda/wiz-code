...
# Test script for StatefulSet Memory Limits Enforcement Policy
# This script tests the Rego policy against various test cases

set -e

POLICY_FILE="policies/memory-limits-enforcement.rego"
TEST_DIR="test-data"
...
echo "Testing StatefulSet Memory Limits Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-statefulset.json" "ALLOWED" "Statefulset with memory limit"

# Invalid cases (should be DENIED/fail)
test_case "invalid-statefulset-missing-memory-limit.json" "DENIED" "Statefulset missing memory limit"
