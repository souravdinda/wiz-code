...
# Test script for DaemonSet Probes Enforcement Policy
...
echo "Testing DaemonSet Probes Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-daemonset-with-probes.json" "ALLOWED" "Daemonset with both liveness and readiness probes"

# Invalid cases (should be DENIED/fail)
test_case "invalid-daemonset-missing-liveness.json" "DENIED" "Daemonset missing liveness probe"
test_case "invalid-daemonset-missing-readiness.json" "DENIED" "Daemonset missing readiness probe"

# Non-Daemonset resources (should be SKIPPED)
test_case "not-daemonset-pod.json" "SKIPPED" "Pod (not a Daemonset, policy doesn't apply)"
