...
# Test script for Pod Mandatory Tags Enforcement Policy
...
echo "Testing Pod Mandatory Tags Enforcement Policy"
echo "============================================="
echo ""
...
test_case "valid-pod-with-tags.json" "ALLOWED" "Pod with all mandatory tags"

# Invalid cases (should be DENIED/fail)
test_case "invalid-pod-missing-tags.json" "DENIED" "Pod missing mandatory tags"
