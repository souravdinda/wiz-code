...
# Test script for StatefulSet Readiness Probes Enforcement Policy
# This script tests the Rego policy against various test cases

set -e

POLICY_FILE="policies/readiness-probe-enforcement.rego"
TEST_DIR="test-data"
...
echo "Testing StatefulSet Readiness Probes Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-statefulset-with-readiness.json" "ALLOWED" "StatefulSet with readiness probe"
