...
# Test script for DaemonSet Memory Limits Enforcement Policy
...
echo "Testing DaemonSet Memory Limits Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-daemonset.json" "ALLOWED" "Daemonset with memory limit"

# Invalid cases (should be DENIED/fail)
test_case "invalid-daemonset-missing-memory-limit.json" "DENIED" "Daemonset missing memory limit"
