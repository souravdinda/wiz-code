# DaemonSet Memory Limits Enforcement Policy

## 📋 Summary

**Policy Name**: DaemonSet Memory Limits Enforcement  
...
Enforce that all Kubernetes DaemonSet containers have memory limits configured to prevent resource contention and unpredictable performance.

## 📝 Description

This policy validates that all containers in Kubernetes DaemonSets have memory limits specified in their resource requirements. This ensures proper resource management and prevents resource contention.

## ✅ Policy Rules

- **Valid**: DaemonSets where all containers have memory limits configured
- **Invalid**: DaemonSets where any container is missing memory limits
- **Skip**: Non-DaemonSet resources (Pods, Services, other workload types, etc.)

## 📁 Project Structure

```
daemonset_memory_limits/
├── README.md                              # This file
...
# Navigate to daemonset_memory_limits
cd daemonset_memory_limits
