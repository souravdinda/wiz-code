...
# Test script for StatefulSet CPU Requests Enforcement Policy
# This script tests the Rego policy against various test cases

set -e

POLICY_FILE="policies/cpu-requests-enforcement.rego"
TEST_DIR="test-data"
...
echo "Testing StatefulSet CPU Requests Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-statefulset.json" "ALLOWED" "Statefulset with cpu request"

# Invalid cases (should be DENIED/fail)
test_case "invalid-statefulset-missing-cpu-request.json" "DENIED" "Statefulset missing cpu request"
