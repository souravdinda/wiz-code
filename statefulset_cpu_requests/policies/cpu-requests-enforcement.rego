...
currentConfiguration := "CPU requests are not set for containers in the statefulset"
expectedConfiguration := "CPU requests should be set for all containers in the statefulset"
