# StatefulSet Cpu Limits Enforcement Policy

## 📋 Summary

**Policy Name**: StatefulSet Cpu Limits Enforcement  
...
Enforce that all Kubernetes StatefulSet containers have CPU limits configured to prevent resource contention and unpredictable performance.

## 📝 Description

This policy validates that all containers in Kubernetes StatefulSets have CPU limits specified in their resource requirements. This ensures proper resource management and prevents resource contention.

## ✅ Policy Rules

- **Valid**: StatefulSets where all containers have CPU limits configured
- **Invalid**: StatefulSets where any container is missing CPU limits
- **Skip**: Non-StatefulSet resources (Pods, Services, other workload types, etc.)

## 📁 Project Structure

```
statefulset_cpu_limits/
├── README.md                              # This file
├── Reference.md                           # Technical reference documentation
├── policies/                              # Policy files
│   └── cpu-limits-enforcement.rego                     # Main Rego policy
├── docs/                                  # Documentation
...
# Navigate to statefulset_cpu_limits
cd statefulset_cpu_limits
