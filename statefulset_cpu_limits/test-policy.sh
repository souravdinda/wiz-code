...
# Test script for StatefulSet CPU Limits Enforcement Policy
# This script tests the Rego policy against various test cases

set -e

POLICY_FILE="policies/cpu-limits-enforcement.rego"
TEST_DIR="test-data"
...
echo "Testing StatefulSet CPU Limits Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-statefulset.json" "ALLOWED" "Statefulset with cpu limit"

# Invalid cases (should be DENIED/fail)
test_case "invalid-statefulset-missing-cpu-limit.json" "DENIED" "Statefulset missing cpu limit"
