...
# Test script for Pod Probes Enforcement Policy
...
echo "Testing Pod Probes Enforcement Policy"
echo "======================================"
echo ""
...
test_case "valid-pod-with-probes.json" "ALLOWED" "Pod with both liveness and readiness probes"

# Invalid cases (should be DENIED/fail)
test_case "invalid-pod-missing-liveness.json" "DENIED" "Pod missing liveness probe"
test_case "invalid-pod-missing-readiness.json" "DENIED" "Pod missing readiness probe"
