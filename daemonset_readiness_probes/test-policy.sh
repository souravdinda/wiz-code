...
# Test script for DaemonSet Readiness Probes Enforcement Policy
...
echo "Testing DaemonSet Readiness Probes Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-daemonset-with-readiness.json" "ALLOWED" "DaemonSet with readiness probe"
