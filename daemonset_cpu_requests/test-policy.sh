...
# Test script for DaemonSet CPU Requests Enforcement Policy
...
echo "Testing DaemonSet CPU Requests Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-daemonset.json" "ALLOWED" "Daemonset with cpu request"

# Invalid cases (should be DENIED/fail)
test_case "invalid-daemonset-missing-cpu-request.json" "DENIED" "Daemonset missing cpu request"
