...
# Test script for Deployment Readiness Probes Enforcement Policy
...
echo "Testing Deployment Readiness Probes Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-deployment-with-readiness.json" "ALLOWED" "Deployment with readiness probe"
