...
# Test script for DaemonSet Memory Requests Enforcement Policy
...
echo "Testing DaemonSet Memory Requests Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-daemonset.json" "ALLOWED" "Daemonset with memory request"

# Invalid cases (should be DENIED/fail)
test_case "invalid-daemonset-missing-memory-request.json" "DENIED" "Daemonset missing memory request"
test_case "invalid-daemonset-no-resources.json" "DENIED" "Daemonset with no resources section"
