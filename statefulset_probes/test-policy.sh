...
# Test script for StatefulSet Probes Enforcement Policy
# This script tests the Rego policy against various test cases

set -e

POLICY_FILE="policies/probes-enforcement.rego"
TEST_DIR="test-data"
...
echo "Testing StatefulSet Probes Enforcement Policy"
echo "========================================"
echo ""
...
# Valid cases (should be ALLOWED)
test_case "valid-statefulset-with-probes.json" "ALLOWED" "Statefulset with both liveness and readiness probes"

# Invalid cases (should be DENIED/fail)
test_case "invalid-statefulset-missing-liveness.json" "DENIED" "Statefulset missing liveness probe"
test_case "invalid-statefulset-missing-readiness.json" "DENIED" "Statefulset missing readiness probe"

# Non-Statefulset resources (should be SKIPPED)
test_case "not-statefulset-pod.json" "SKIPPED" "Pod (not a Statefulset, policy doesn't apply)"
