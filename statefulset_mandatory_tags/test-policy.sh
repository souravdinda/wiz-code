...
# Test script for StatefulSet Mandatory Tags Enforcement Policy
# This script tests the Rego policy against various test cases

set -e

POLICY_FILE="policies/mandatory-tags-enforcement.rego"
TEST_DIR="test-data"
...
echo "Testing StatefulSet Mandatory Tags Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-statefulset-with-tags.json" "ALLOWED" "Statefulset with all mandatory tags"

# Invalid cases (should be DENIED/fail)
test_case "invalid-statefulset-missing-tags.json" "DENIED" "Statefulset missing mandatory tags"
