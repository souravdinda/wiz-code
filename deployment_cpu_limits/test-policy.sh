...
# Test script for Deployment CPU Limits Enforcement Policy
...
echo "Testing Deployment CPU Limits Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-deployment.json" "ALLOWED" "Deployment with cpu limit"

# Invalid cases (should be DENIED/fail)
test_case "invalid-deployment-missing-cpu-limit.json" "DENIED" "Deployment missing cpu limit"
