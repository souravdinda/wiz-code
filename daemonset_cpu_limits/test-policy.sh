...
# Test script for DaemonSet CPU Limits Enforcement Policy
...
echo "Testing DaemonSet CPU Limits Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-daemonset.json" "ALLOWED" "Daemonset with cpu limit"

# Invalid cases (should be DENIED/fail)
test_case "invalid-daemonset-missing-cpu-limit.json" "DENIED" "Daemonset missing cpu limit"
