# DaemonSet Cpu Limits Enforcement Policy

## 📋 Summary

**Policy Name**: DaemonSet Cpu Limits Enforcement  
...
Enforce that all Kubernetes DaemonSet containers have CPU limits configured to prevent resource contention and unpredictable performance.

## 📝 Description

This policy validates that all containers in Kubernetes DaemonSets have CPU limits specified in their resource requirements. This ensures proper resource management and prevents resource contention.

## ✅ Policy Rules

- **Valid**: DaemonSets where all containers have CPU limits configured
- **Invalid**: DaemonSets where any container is missing CPU limits
- **Skip**: Non-DaemonSet resources (Pods, Services, other workload types, etc.)

## 📁 Project Structure

```
daemonset_cpu_limits/
├── README.md                              # This file
...
# Navigate to daemonset_cpu_limits
cd daemonset_cpu_limits
