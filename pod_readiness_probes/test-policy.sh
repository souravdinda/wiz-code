...
# Test script for Pod Readiness Probes Enforcement Policy
...
echo "Testing Pod Readiness Probes Enforcement Policy"
echo "========================================"
echo ""
...
test_case "valid-pod-with-readiness.json" "ALLOWED" "Pod with readiness probe"
